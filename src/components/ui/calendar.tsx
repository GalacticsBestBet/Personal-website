  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav: "absolute left-0 top-0 right-0 flex justify-between items-center px-1",
        nav_button: cn(
        ...
        day_outside:
          "day-outside text-muted-foreground opacity-50 aria-selected:bg-accent/50 aria-selected:text-muted-foreground aria-selected:opacity-30 invisible",
        day_disabled: "text-muted-foreground opacity-50",
        day_button: "flex h-9 w-9 items-center justify-center",
        day_range_middle:
